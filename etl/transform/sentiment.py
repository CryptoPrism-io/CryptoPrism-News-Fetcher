...
Usage:
    python -m etl.transform.sentiment --batch-size 64 --from-date 2025-10-21
    python -m etl.transform.sentiment --batch-size 64  # processes all unscored articles
"""
...
def run(batch_size: int = 64, from_date: str | None = None):
    ...
    from etl.transform.coin_mapper import map_categories_to_slugs, get_source_tier
    from etl.transform.event_classifier import classify_event

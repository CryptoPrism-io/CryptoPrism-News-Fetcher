...
Usage:
    python -m ml.features.btc_residuals                      # incremental (latest hour)
    python -m ml.features.btc_residuals --backfill            # full backfill from hourly data
"""
...
from crypto_db import get_backtest_conn, get_backtest_h_conn

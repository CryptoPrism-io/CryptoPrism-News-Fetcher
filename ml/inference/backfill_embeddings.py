...
Usage:
    python -m ml.inference.backfill_embeddings --model lstm
    python -m ml.inference.backfill_embeddings --model tcn
    python -m ml.inference.backfill_embeddings --model both
"""
...
from crypto_db import get_backtest_conn, get_backtest_h_conn, get_db_conn
...
def backfill_lstm():
    ...
    from ml.models.lstm_extractor import (

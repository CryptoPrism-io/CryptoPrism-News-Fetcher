...
Usage:
    python -m ml.inference.daily_signals
    python -m ml.inference.daily_signals --date 2026-02-24
"""
...
def fetch_today_features(conn, features: list[str], target_date: str) -> list[dict]:
    ...
    """
    import pandas as pd
    from crypto_db import get_backtest_conn
...
def run(target_date: str | None = None):
    ...
    with track("ml_daily_signals") as t:
        ...
        from ml.models.train_lgbm import get_top_universe_slugs
        from crypto_db import get_backtest_conn
        try:
        ...
        try:
            ...
            from ml.models.train_ensemble import apply_regime_gating

...
Usage:
    python -m ml.inference.hourly_signals
    python -m ml.inference.hourly_signals --date 2026-04-09
"""
...
from crypto_db import get_db_conn, get_backtest_conn
from ml.models.train_ensemble import (
...
def run(target_date: str | None = None):
    ...
    from ml.inference.etl_tracker import track
    from ml.models.registry import get_active_model
    from ml.models.train_ensemble import load_ensemble_features
    ...
    with track("ensemble_hourly_signals") as t:
        ...
        from ml.inference.daily_signals import fetch_today_features

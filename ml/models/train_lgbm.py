...
Usage:
    python -m ml.models.train_lgbm --mode price_only
    python -m ml.models.train_lgbm --mode news_augmented
"""
...
def train(mode: str = "price_only"):
    ...
    from ml.models.evaluate import full_eval
    from ml.models.registry import register_model, save_backtest, set_active_model
    ...
    if df_val.empty or df_test.empty:
        log.error(
            ...
            f"Run: python -m ml.features.labels --from-date {split['val_from']}"
        )
        raise SystemExit(1)

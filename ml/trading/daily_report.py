...
Usage:
    python3 -m ml.trading.daily_report                 # full daily report (23:00 UTC)
    python3 -m ml.trading.daily_report --hourly        # compact P&L snapshot (every hour)
    python3 -m ml.trading.daily_report --cycle         # post-trade cycle report (every 4h)
"""

...
def save_to_csv(data, timestamp):
    ...
    filename = f"data/csv_exports/crypto_news_{timestamp}.csv"
...
def save_full_json(data, timestamp):
    ...
    filename = f"data/json_exports/crypto_news_{timestamp}.json"
...
if __name__ == "__main__":
    ...
    print(f"   Analysis: data/analysis/analysis_{timestamp}.json")
